...
private const val TAG = "MyProductOrdersViewModel"
class MyProductOrdersViewModel(
    private val application: Application,
    private val isMedicalProducts:Int,/* medicalProducts -> 1, Famous products -> 2 */
    ...
    fun getOrders() {
        viewModelScope.launch {
            try {
                ...
                val apiResponse = repo.getOrders(isMedicalProducts)
                if (apiResponse.status) {
                    if ((apiResponse.data as MutableList<ProductOrder>).isEmpty())
