...
private const val TAG = "HospitalReservationsViewModel"

class MyHospitalReservationsViewModel(
    val application: Application,
    val repo: HospitalsRepository
) : ViewModel() {
        ...
        viewModelScope.launch {
            try {
                ...
                if (apiResponse.status) {
                    if ((apiResponse.data as MutableList<HospitalBooking>).isEmpty())
                ...
                Log.d(TAG, "HospitalReservations-Req. Failed: $e")
