...
import code_grow.afeety.app.databinding.FragmentMyProductOrdersBinding
...
class MyProductOrdersFragment : Fragment() {
    private lateinit var binding: FragmentMyProductOrdersBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMyProductOrdersBinding.inflate(inflater, container, false)
    ...
    companion object {
        @JvmStatic
        fun newInstance() = MyProductOrdersFragment()
    }
}